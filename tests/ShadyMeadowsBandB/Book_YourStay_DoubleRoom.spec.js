...
await page.locator("(//a[@class='btn btn-primary'][normalize-space()='Book now'])[contains(@href,'/reservation/2?')]").click();

const roomName= await page.locator("//h1[.='Double Room']").textContent();
console.log("Room Details"+roomName)
expect (roomName.includes("Double Room")).toBeTruthy
